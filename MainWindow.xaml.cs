...
namespace bhuylebr.kinect.scratch
{
    ...
    public partial class MainWindow : Window, INotifyPropertyChanged
    {
        ...
        //@DELETE
        //private IDisposable kinectWebServer = null;
        ...
        private void MainWindow_Loaded(object sender, RoutedEventArgs e)
        {
            ...
            //@DELETE
            //Bahuman addition to start webserver
            //string baseAddress = "http://localhost:15002/";
            // Start OWIN host 
            //var startOptions = new StartOptions(baseAddress);
            //this.kinectWebServer = WebApp.Start<KinectStartup>(url: baseAddress);
            ScratchWebServer.Start();
        }
        ...
        private void MainWindow_Closing(object sender, CancelEventArgs e)
        {
            ...
            //if (this.kinectWebServer != null)
            //{
            //    this.kinectWebServer.Dispose();
            //    this.kinectWebServer = null;
            //}
            ScratchWebServer.Stop();
        }
        ...
        private void DrawBody(int bodyCount, IReadOnlyDictionary<JointType, Joint> joints, IDictionary<JointType, Point> jointPoints, DrawingContext drawingContext, Pen drawingPen)
        {
            // Draw the bones
